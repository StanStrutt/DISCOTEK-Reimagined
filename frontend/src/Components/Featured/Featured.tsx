...
export default function Featured() {
	...
	// tracking if the mouse is currently hovering the the left image of featured
	useEffect(() => {
	...
	return (
		<div className="featured">
			<div className="left-featured" ref={containerRef}>
				{/*
					slider tracks the cursor position and aligns the y axis with it to make sure
					that the slide follows it 
				*/}
				<img
					className="slider"
					src="slider.png"
					style={{ transform: `translateY(${cursorPosition.y - window.innerHeight * 0.02}px)` }}
				/>
				{/* 
					over-image does a similar thing as the above element but starts overlapping
					one image with the other as the cursor is moved 
				*/}
				<div
					className="over-image"
					style={{ height: `${cursorPosition.y}px` }}
				/>
				<div className="left-featured-text">
					...
					<a href="https://firefly.adobe.com/" target="_blank" rel="noopener">Try it now</a>
				</div>
			</div>
