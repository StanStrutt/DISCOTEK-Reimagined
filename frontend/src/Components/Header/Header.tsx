        ...
        <div className="header">
            ...
            <div className="front-page">
                <div className="left-text">
                    ...
                    <p>
                        DISCoTek is a website which provides hundreds of resources from all over
                        the web from productivity tools to the latest AI.
                    </p>
                    <p>
                        Run by DISC, a specialist college in Manchester for 16 - 25 year olds,
                        which allows young people to progress their career in the digital sector.
                    </p>
            ...
            <div className="bottom-bar">
                <a>
                    <img 
                        className="scroll"
                        onClick={scrollDown} /* Application of the scrolldown function and applied to a button */ 
                        src="scroll.png"
                        alt="scroll button"
                    />
                </a>
